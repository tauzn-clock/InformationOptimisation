...
img_over_pcd(pcd, mask_to_hsv(mask), filepath=f"{SAVE_DIR}/{NOISE_LEVEL}_default_pcd_corner.png")
...
img_over_pcd(pcd, mask_to_hsv(mask.reshape(depth.shape)), filepath=f"{SAVE_DIR}/{NOISE_LEVEL}_our_pcd_corner.png")
